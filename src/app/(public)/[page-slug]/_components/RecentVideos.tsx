                        ...
                        >
                            <div className="relative w-24 h-16 shrink-0 overflow-hidden bg-n-6">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/40 transition-colors">
                                    <Icon name="youtube" className="w-5 h-5 fill-white opacity-80 group-hover:opacity-100 transition-opacity" />
                                </div>
                                {duration && (
                                    <div className="absolute bottom-1 right-1 px-1 bg-black/60 rounded text-[10px] text-white font-medium">
                                        {duration}
                                    </div>
                                )}
                            </div>
                            <div className="flex-1 min-w-0">
                                <p className="text-sm line-clamp-2 leading-snug group-hover:text-purple-1 transition-colors">
                                    {title}
                                </p>
                                <div className="flex items-center gap-2 mt-1 text-xs text-n-3">
                                    <span>{date}</span>
                                </div>
                            </div>
                        </Link>
