    ...
    return (
        <>
            <div className={`flex items-center ${className}`}>
                ...
                {showComment && (
                    <button
                        className="flex items-center gap-1 ml-4 px-0 cursor-pointer dark:text-n-8"
                        onClick={(e) => {
                            e.stopPropagation();
                            if (onCommentClick) {
                                onCommentClick();
                    ...
                    >
                        <Icon icon={MessageCircle} className="" />
                ...
                {type === 'post' ? (
                    ...
                    showComment && (
                        <button
                            className={` ml-4 cursor-pointer dark:text-n-8`}
                            onClick={(e) => {
                                e.stopPropagation();
