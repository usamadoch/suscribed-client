                ...
                <div className="">
                    ...
                    >
                        ...
                        {textarea ? (
                            <textarea
                                className={twMerge(
                                    `w-full h-24 px-5 py-3 bg-white border border-n-1 text-sm text-n-1 font-bold outline-none resize-none transition-colors placeholder:text-n-3 focus:border-purple-1 dark:bg-n-3 dark:border-n-6 dark:text-n-9 dark:focus:border-purple-1 dark:placeholder:text-n-8 ${icon ? "pr-15" : ""
                            ...
                            <input
                                className={twMerge(
                                    `w-full h-16 bg-white border border-n-1 text-sm text-n-1 font-bold outline-none transition-colors placeholder:text-n-3 focus:border-purple-1 dark:bg-n-3 dark:border-n-6 dark:text-n-9 dark:focus:border-purple-1 dark:placeholder:text-n-8 ${icon || type === "password" ? "pr-15" : ""
                                    } ${error ? "pr-15 border-pink-1!" : ""} ${image || currency ? "pr-15" : ""
                                    } ${classInput}`,
